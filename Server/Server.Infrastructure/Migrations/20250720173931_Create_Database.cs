        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    payment_failed_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    payment_failure_reason = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    payment_expired_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    amount = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    currency = table.Column<string>(type: "character varying(3)", maxLength: 3, nullable: false),
                    refund_reason = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    ...
                    refund_failure_reason = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    has_pending_payments = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    has_active_payments = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    has_failed_payments = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    has_disputed_payments = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    total_refunded_amount = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    total_refunded_amount_currency = table.Column<string>(type: "character varying(3)", maxLength: 3, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "ix_order_products_order_id_for_totals",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_products_status_total_stock",
                table: "products",
                columns: new[] { "status", "total_stock" });
            ...
            migrationBuilder.CreateIndex(
                name: "ix_users_created_at_email",
                table: "users",
                columns: new[] { "created_at", "email" });

            migrationBuilder.CreateIndex(
                name: "ix_users_created_at_first_name",
                table: "users",
                columns: new[] { "created_at", "first_name" });

            migrationBuilder.CreateIndex(
                name: "ix_users_created_at_last_name",
                table: "users",
                columns: new[] { "created_at", "last_name" });
