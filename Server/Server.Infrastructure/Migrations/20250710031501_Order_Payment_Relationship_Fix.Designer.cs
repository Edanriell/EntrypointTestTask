...
namespace Server.Infrastructure.Migrations
{
    ...
    [Migration("20250710031501_Order_Payment_Relationship_Fix")]
    partial class Order_Payment_Relationship_Fix
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Server.Domain.Orders.Order", b =>
                {
                    ...
                    b.HasOne("Server.Domain.Payments.Payment", "Payment")
                        .WithOne("Order")
                        .HasForeignKey("Server.Domain.Orders.Order", "PaymentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_orders_payment_payment_id");
