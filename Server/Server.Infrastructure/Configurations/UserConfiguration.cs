...
internal sealed class UserConfiguration : IEntityTypeConfiguration<User>
{
    public void Configure(EntityTypeBuilder<User> builder)
    {
        ...
        // ✅ REMOVED: Direct navigation to Orders (DDD violation)
        // Orders should be accessed via repository queries using ClientId
        ...
        //     .OnDelete(DeleteBehavior.Cascade);
        //
        // builder.Navigation("_orders")
        //     .UsePropertyAccessMode(PropertyAccessMode.Field);

        // Test
        // builder.HasMany<Role>("_roles")
        //     .WithMany()
        //     .UsingEntity("user_roles", // Junction table name
