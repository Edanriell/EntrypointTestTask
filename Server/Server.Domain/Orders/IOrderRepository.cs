...
public interface IOrderRepository
{
    ...
    Task<Order?> GetByIdNoTrackingAsync(Guid id, CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<Order>> GetActiveOrdersByUserIdAsync(Guid clientId, CancellationToken cancellationToken = default);
